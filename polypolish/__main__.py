...
def main():
    ...
    alignments = load_alignments(args.sam, args.max_errors)
...
def parse_args():
    ...
    required_args.add_argument('sam', type=str, nargs='+',
                               help='Input short read alignments (SAM format, one or more files)')
